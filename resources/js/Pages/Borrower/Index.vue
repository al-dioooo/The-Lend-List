<template>
    <app-layout title="Borrower List">
        <topbar title="Borrower List" />
                ...
                <table
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-800">
                        ...
                        <tr v-for="datasheet in datasheet.data" :key="datasheet.id">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900 overflow-ellipsis dark:text-white">
                                    {{datasheet.email ? datasheet.email : datasheet.contact}}
                                </div>
                                <div class="overflow-hidden text-sm text-gray-500 w-44 overflow-ellipsis" v-if="datasheet.email">
                                    {{datasheet.contact}}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                <div class="inline-flex items-center space-x-4">
                                    <button @click="edit(datasheet)" class="inline-flex items-center p-2 space-x-4 text-white transition bg-gray-800 rounded-full active:hover:scale-90">
                                    ...
                                    <button @click="destroy(datasheet)" class="inline-flex items-center p-2 space-x-4 text-white transition bg-red-800 rounded-full active:hover:scale-90">
...
import Create from '@/Pages/Borrower/Create'
import Edit from '@/Pages/Borrower/Edit'
import Delete from '@/Pages/Borrower/Delete'
